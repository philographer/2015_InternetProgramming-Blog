...
<body>
	...
	if (request.getParameter("p") != null)
		...
		String sqlStr = "select d_ArticleNum, d_author ,d_title, d_Write_time, d_readcount, d_up, d_down from my_diary order by d_ArticleNum desc limit 5 offset ?;";
		...
		%>
		<h1 class="title">FoodDiary board</h1>
		<table border="0">
			<tr>
				<th>Article Num</th>
				<th>Title</th>
			...
			%>
			<tr>
				<td class="ta_c"><%= rset.getInt("d_ArticleNum") %></td>
				<td>
					<a href='jsp_diary_view.jsp?d_ArticleNum=<%= rset.getInt("d_ArticleNum") %>' class="name">
						<%= rset.getString("d_title") %>
					</a>
				</td>
				<td><%= rset.getString("d_author") %></td>
				<td class="ta_c"><%= rset.getString("d_Write_time") %></td>
				<td class="ta_c"><%= rset.getInt("d_readcount") %></td>	
				<td class="ta_c"><%= rset.getInt("d_up") %></td>	
				<td class="ta_c"><%= rset.getInt("d_down") %></td>	
		...
		<tr>
			<td colspan="7" class="th_submit ta_c">
